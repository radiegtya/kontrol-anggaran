...
<?php echo $form->dropDownListRow($model, 'satker_code', Satker::model()->getSatkerOptions(), array('class' => 'span5', 'maxlength' => 4)); ?>
...
<div class = "form-actions">
    ...
    ?>
    <!--<a href="<?php // echo yii::app()->baseUrl;    ?>/activity/admin" class="btn btn-primary">Batal</a>-->
