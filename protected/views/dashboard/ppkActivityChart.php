<div class="panel">
    <div class="panel-header">
        <h3>Diagram Penyerapan Anggaran Ppk <?php echo $ppk->official_name; ?> Per Kegiatan</h3>
    </div>

    <div class="panel-body">
        <div class="charts">
            <?php for ($i = 0; $i < count($activityLists); $i++): ?>
                <div class="chart-items">
                    <div class="chart-item">
                        <?php echo CHtml::link($activityLists[$i], array("dashboard/ppkOutputChart", "id" => $id[$i], "ppkId" => $ppk->id)); ?>
