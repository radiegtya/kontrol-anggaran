<div class="panel">
    <div class="panel-header">
        <h3>Diagram Penyerapan Anggaran Ppk <?php echo $ppk->official_name; ?> Per Suboutput</h3>
    </div>

    <div class="panel-body">
        <div class="charts">
            <?php for ($i = 0; $i < count($suboutputLists); $i++): ?>
                <div class="chart-items">
                    <div class="chart-item">
                        <?php echo CHtml::link($suboutputLists[$i], array("dashboard/ppkComponentChart", "id" => $id[$i], "ppkId" => $ppk->id)); ?>
