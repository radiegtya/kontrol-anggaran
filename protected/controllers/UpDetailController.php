...
class UpDetailController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('UpDetail');
    ...
    public function actionEditable() {
        ...
        $es = new TbEditableSaver('UpDetail');
        $es->update();
    }
     ...
     */
    protected function performAjaxValidation($model, $formId = 'up-detail-form') {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'up-detail-form') {
    ...
    public function sendEmail() {
        ...
        $message = $this->renderPartial('/up-detail/sendEmail', array(''), true);
