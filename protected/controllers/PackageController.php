    ...
    public function actionEntry() {
        ...
        if (isset($_POST['code'])) {
            if ($lastDipa) {
                ...
                for ($i = 0; $i <= $total; $i++) {
                    if (isset($_POST['code'][$i]) && $_POST['code'][$i] != NULL && $_POST['ppk_code'][$i] != NULL && $_POST['province_code'][$i] != NULL && $_POST['city_code'][$i] != NULL) {
                        $code = $_POST['code'][$i];
                        ...
                        if ($record) {
                            ...
                            $record->province_code = $_POST['province_code'][$i];
                            ...
                            if ($budget) {
                                ...
                                $data->province_code = $_POST['province_code'][$i];
