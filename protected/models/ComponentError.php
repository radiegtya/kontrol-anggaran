...
/**
 * This is the model class for table "component_error".
 *
 * The followings are the available columns in table 'component_error':
 * @property integer $id
 ...
 */
class ComponentError extends VAbstractActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('code, suboutput_code, name', 'required'),
            array('created_by, updated_by', 'numerical', 'integerOnly' => true),
            array('code, satker_code, activity_code, output_code, suboutput_code, name', 'length', 'max' => 256),
            array('created_at, updated_at', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, code, satker_code, activity_code, output_code, suboutput_code, name, created_at, created_by, updated_at, updated_by', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return ComponentError the static model class
     */
