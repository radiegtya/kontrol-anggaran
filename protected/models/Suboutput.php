 ...
 */
class Suboutput extends VAbstractActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('satker_code, activity_code, code, output_code, name', 'length', 'max' => 256),
    ...
    public function attributeLabels() {
        return array(
            'id' => 'ID',
            'code' => 'Kode Sub Output',
            'satker_code' => 'Satker',
            'activity_code' => 'Kegiatan',
            'output_code' => 'Output',
            'name' => 'Nama Sub Output',
            'created_at' => 'Dibuat',
            'created_by' => 'Oleh',
...
//            ),
    ...
    public function getSuboutputOptions() {
