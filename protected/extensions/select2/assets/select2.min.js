...
(function ($, undefined) {
        ...
        positionDropdown: function () {
            ...
            this.container.parents().add(window).each(function () {
                $(this).bind(resize + " " + scroll + " " + orient, function (e) {
                    $("#select2-drop-mask").css({width: document.documentElement.scrollWidth, height: document.documentElement.scrollHeight});
    ...
    SingleSelect2 = clazz(AbstractSelect2, {createContainer: function () {
            ...
            this.focusser.bind("keydown", this.bind(function (e) {
                if (!this.enabled)
                    return;
                if (e.which === KEY.TAB ||
                        KEY.isControl(e) || KEY.isFunctionKey(e) || e.which === KEY.ESC)
                    return;
            ...
            if (opts.element.get(0).tagName.toLowerCase() === "select")
                ...
                opts.initSelection = opts.initSelection || function (element, callback) {
                    var id = element.val();
                    opts.query({matcher: function (term,
                                text, el) {
            ...
            this.opts.element.trigger({type: "selected",
    ...
    $.fn.select2.defaults = {width: "copy", loadMorePadding: 0, closeOnSelect: true, openOnEnter: true, containerCss: {}, dropdownCss: {}, containerCssClass: "", dropdownCssClass: "", formatResult: function (result, container, query, escapeMarkup) {
        ...
        selectOnBlur: false, adaptContainerCssClass: function (c) {
            return c
